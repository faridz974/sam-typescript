...
- hello-world-2 - Code for the application's Lambda function written in TypeScript.
- shared - Shared code for all application's Lambda function written in TypeScript
